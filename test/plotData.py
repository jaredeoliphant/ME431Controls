...
class plotData:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[0],
                                  ylabel='$z_3$ (m)',
                                  title='Double Mass-Spring-Damper Data'))
    ...
    def updatePlots(self,t,reference,states,ctrl):
        ...
        self.z_history.append(states[2][0])  # we are tracking state 3 in this case
        self.force_history.append(.001*ctrl) # convert to kN
